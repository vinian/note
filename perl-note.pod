...
substitle
C<my $interpolation = "We will interpolated variables";
print <<"END";
...
C<perl -le 'print join "\n", @INC'>

C<perl -MLWP -e 'print map {"$_ => $INC{$_}\n"} sort keys %INC'>
...
C<perl -pi'old/*.orig' -e 's/bar/baz/' fileA> # backup to 'old/fileA.orig'

C<perl -pi -e 's/bar/baz/' fileA> # overwrite current file

C<perl -pi'*' -e 's/bar/baz/' fileA> # overwrite current file

C<perl -pi'.orig' -e 's/bar/baz/' fileA> # backup to 'fileA.orig'

C<perl -pi'*.orig' -e 's/bar/baz/' fileA> # backup to 'fileA.orig'

a fancy way copy file

C<perl -p -i'/some/file/path/*' -e 1 file1 file2 file3...>

or

C<perl -p -i'.orig' -e 1 file1 file2 file3...>
