...
=item B<1.文件中匹配部分之间的内容>

处理一个文件中!! START !! 到 !! END !! 间的数据
...
相关符号 $/; $\, 输入和输出文件描述符
参考文档  http://www.perl.com/pub/2004/06/18/variables.html

=item B<2.显示一个文件的前10行>
